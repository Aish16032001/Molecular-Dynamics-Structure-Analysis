...
<div style="position: relative; width: 82%; max-width: 800px; margin: auto; text-align: center;">
 <img src="./user.png" alt="Atmosphere Background" style="width: 82%; display: block;">
